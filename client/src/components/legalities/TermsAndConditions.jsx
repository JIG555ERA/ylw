    ...
    return (
        <div className='w-full min-h-screen h-auto bg-gradient-to-br from-blue-100 via-white to-purple-100 font-[Poppins]'>
            ...
            className='w-full mb-[80px] h-auto flex flex-col 2xl:px-[120px] lg:px-[80px] md:px-[40px] px-[16px] items-center md:pt-[100px]'>
                <h2 className="md:text-[54px] text-[32px] font-bold my-4 ">Terms &amp; Conditions</h2>

                <section className="max-w-4xl mx-auto p-6">
                <div id="terms-conditions" className="bg-white p-6 rounded-lg shadow mb-6">
                    ...
                    <li>
                        This document is published in accordance with the provisions of <b>Rule 3 (1) of the Information
                        Technology (Intermediaries guidelines) Rules, 2011</b> that require publishing the rules and
                        regulations, privacy policy and Terms of Use for access or usage of domain name <b>ylw.co.in</b>
                        ("Website"), including the related mobile site and mobile application (hereinafter referred to
                        as "Platform").
                    </li>

                    <li>
                        The Platform is owned by <b>SY DART TECH</b>, a company incorporated under the Companies Act,
                        1956 with its registered office at <b>101 Vasudev chambers Opposite D mart Bhandup - 400078</b>
                    ...
                    <li>
                        <b>ACCESSING, BROWSING OR OTHERWISE USING THE PLATFORM INDICATES YOUR AGREEMENT TO ALL
                        THE TERMS AND CONDITIONS UNDER THESE TERMS OF USE, SO PLEASE READ THE TERMS OF USE
                        CAREFULLY BEFORE PROCEEDING.</b>
                    </li>
                ...
                {/* <div className='fixed bottom-0 w-full h-[80px] flex justify-center items-center bg-[#FFFFFF] '>
                    ...
                    type="checkbox" />
                    <p className='md:text-[16px] text-[14px] font-semibold'> I agree to the above Terms and Conditions</p>
                </div> */}
            </div>
            <PhoneNavBar />
        </div>
