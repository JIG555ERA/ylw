    ...
    return (
        <div className='w-full min-h-screen h-auto bg-gradient-to-br from-blue-100 via-white to-purple-100 font-[Poppins]'>
            ...
            className='w-full mb-[80px] h-auto flex flex-col 2xl:px-[120px] lg:px-[80px] md:px-[40px] px-[16px] items-center md:pt-[100px]'>
                {/* <h1 className='xl:text-[56px] md:text-[44px] text-[24px] font-bold text-center bg-gradient-to-br from-blue-300 via-blue-500 to-purple-300 bg-clip-text text-transparent'>Privacy Policy</h1> */}
                <h2 className="md:text-[54px] text-[32px] font-bold my-4 ">Privacy Policy</h2>

                <section className="max-w-4xl mx-auto p-6">
                <div id="privacy-policy" className="bg-white p-6 rounded-lg shadow mb-6">
                    {/* <h2 className="text-2xl font-bold mb-4">Privacy Policy</h2> */}

                    <p className="list-decimal pl-6 space-y-3">
                    
                        <b>Introduction</b>  

                        <p>
                            This Privacy Policy describes how <b>SY DART TECH</b> and its affiliates (collectively "<b>SY DART TECH</b>,
                            we, our, us") collect, use, share, protect or otherwise process your information/ personal data through our
                            website <b>ylw.co.in</b> (hereinafter referred to as <b>Platform</b>). Please note that you may be able to browse
                        ...
                        <p>
                            <b>Collection</b>-We collect your personal data when you use our Platform, services or otherwise interact with
                            ...
                            any information. If you receive an email, a call from a person/association claiming to be <b>SY DART
                            TECH</b> seeking any personal data like debit/credit card PIN, net-banking or mobile banking password, we
                        ...
                        <p>
                            <b>Usage</b>- We use personal data to provide the services you request. To the extent we use your personal data
                        ...
                        <p>
                            <b>Sharing</b>- We may share your personal data internally within our group entities, our other corporate
                        ...
                        <p>
                            <b>Security Precautions</b>- To protect your personal data from unauthorised access or disclosure, loss or
                        ...
                        <p>
                            <b>Data Deletion and Retention</b>- You have an option to delete your account by visiting your profile and
                        ...
                        <p>
                            <b>Your Rights</b>- You may access, rectify, and update your personal data directly through the functionalities
                            provided on the Platform.

                        </p>

                        <p>
                            <b>Consent</b>- By visiting our Platform or by providing your information, you consent to the collection, use,
                        ...
                        <p>
                            <b>Changes to this Privacy Policy</b>- Please check our Privacy Policy periodically for changes. We may
                ...
                {/* <div className='fixed bottom-0 w-full h-[80px] flex justify-center items-center bg-[#FFFFFF] '>
                    ...
                    type="checkbox" />
                    <p className='md:text-[16px] text-[14px] font-semibold'> I agree to the above Privacy Policy</p>
                </div> */}
            </div>
            <PhoneNavBar />
        </div>
