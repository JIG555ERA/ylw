    ...
    return (
        ...
        className='md:w-[330px] md:h-[450px] rounded-3xl flex flex-col bg-[#f9f9f9] overflow-hidden md:gap-[20px] group font-[Poppins] shadow hover:shadow-md hover:shadow-gray-300 cursor-pointer'>
            ...
            className='h-[180px] w-full overflow-hidden'>
                <img 
                className='w-full bg-cover group-hover:scale-110 transition-all delay-200 duration-600 linear'
                src={context.img} 
                alt={context.img} />
            </div>
            <div
            className='w-full flex flex-col h-[170px] items-center lg:px-[24px] px-[16px]'>
                <h1 className='text-[24px] font-medium bg-clip-text text-transparent bg-gradient-to-br from-blue-300 via-blue-500 to-purple-400'> {context.name} </h1>
                <p className='text-[14px] text-[#7C7C7C]/60 font-medium line-clamp-3 text-center my-[12px]'> {context.description} </p>
                <div
