...
export const BookListings = () => {
    ...
    return (
        <div className="lg:mx-[80px] mx-[16px] mt-[40px] pb-[100px] font-[Poppins]">
            ...
            <div className="books-listing-title-section flex justify-between mt-[30px]">
                <div className="selected-categroy-title-section">
                    <p className="translate-y-[4px] lg:text-[24px] text-[18px] font-semibold">
            ...
            <div className="grid xl:grid-cols-6 md:grid-cols-4  grid-cols-2 w-full mt-5 lg:gap-12 gap-[16px] lg:translate-x-[-12px]">
                {booksData.map((book) => (
